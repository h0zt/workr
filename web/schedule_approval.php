<?php
    ...
    $output = new OutPut();
    $input = new Input();
    $schedules = $output->allScheduledGuards();
?>
...
<head>
    ...
    <title>Rock Security Services | Schedule </title>
    <!-- Favicon icon -->
                ...
                <ul class="metismenu" id="menu">
                   ...
                   <li>
                       <a class="has-arrow" href="schedule_approval.php" >
                           <i class=" menu-icon"></i><span class="nav-text">Schedule</span>
                       </a>
                   </li>
                   <li>
                                    ...
                                    <?php foreach($schedules as $schedule){ ?>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input  type="hidden"  name="contact" value="<?=$schedule['contact']?>">
                                            </td>
                                            <td><?=$schedule['firstname']?> <?=$schedule['lastname']?></td>
                                            <td><input type="date" name="date" class="form-control-md" required></td>
                                            <td>
                                            <?php if($schedule['schedule'] =='interview'){ ?>
                                                <input type="submit" class="btn btn-sm btn-outline-primary" name ="schedule" value="training">
                                             <?php } else {?>
                                                <input type="submit" class="btn btn-sm btn-outline-primary" name ="schedule" value="interview">
                                                <input type="submit" class="btn btn-sm btn-outline-primary" name ="schedule" value="training">
                                            <?php } ?>
                                            </td>
                                        </tr>
