<?php
    ...
    $output = new OutPut();
    $attendance = $output->AttendanceReport();
    //$guards = $output->allGuards();
    //make some guards attendance query
?>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                       <a class="has-arrow" href="attendance_report.php" >
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="dataTables" style="width:100%" class="table table-striped table-bordered zero-configuration display nowrap">
                                        <thead>
                                            <tr>
                                                <th scope="col" colspan="2">Guard Name</th>
                                                <th scope="col">Attended Days</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach($attendance as $report){ ?>
                                            <tr>
                                                <td><span><?=$report['firstname']?></span> </td>
                                                <td><span><?=$report['lastname']?></span> </td>
                                                <td>
                                                    <span>
                                                        <a class="text-primary" href="guards_attendance.php?id=<?=$report['identification']?>"><?=$report['count_no']?> - view</a>
                                                    </span>
                                                </td>
                                            </tr>
                                            <?php } ?>
