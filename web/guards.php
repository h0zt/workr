                                    ...
                                    <table class="table table-striped zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="text-primary" href="guards_details.php?id=<?=$guard['id']?>">view- <?=$guard['identification']?></a></td>
                                                <td><a class="text-primary" href="inventory_add.php?id=<?=$guard['id']?>">add</a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
