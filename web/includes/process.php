...
class InPut{
    ...
    /**
     * @TESTED
     * update on trainings and Interviews then send emails to guards accounts
     */
    public function setSchedule($id,$schedule,$date,$contact){
        ...
        if($dbconnect->exec($query)){
            ...
            $mail->SMTPAuth = true;
            $mail->Username ='peter16matewere@gmail.com';//replace with your gmail account
            $mail->Password = 'euvytvijgcnlucwi';//replace this gmail app password
            $mail->SMTPSecure = 'ssl';//
            $mail->Port = '465';
            $mail->setFrom('peter16matewere@gmail.com'); //replace with you
