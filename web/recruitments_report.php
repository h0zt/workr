<?php
    ...
    $output = new OutPut();
    $recruitments = $output->RecruitmentReport();
?>
...
<head>
    ...
    <title>Rock Security Services | Recruitment Report</title>
    <!-- Favicon icon -->
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                       <a class="has-arrow" href="recruitments_report.php" >
        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Recruitments</a></li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="dataTables" style="width:100%" class="table table-striped table-bordered zero-configuration display nowrap">
                                        ...
                                        <tbody>
                                            <?php foreach($recruitments as $report){ ?>
                                            <tr>
                                                <td><span><?=$report['firstname']?></span> <span><?=$report['lastname']?></span> </td>
                                                <td><span><?php 
                                                    if($report['schedule']=='interview'){
                                                        echo '<b style="color:#7571f9">&#9745;</b>';
                                                    }
                                                ?></span> </td>
                                                <td><span><?php 
                                                    if($report['schedule']=='training'){
                                                        echo '<b style="color:#7571f9">&#9745;</b>';
                                                    }
                                                ?></span> </td>
                                            </tr>
