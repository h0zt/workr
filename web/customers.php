...
<head>
    ...
    <title>Rock Security Services | List</title>
    <!-- Favicon icon -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <?php foreach($result as $row){ ?>
                                            <tr>
                                                <td><?=$row['name']?></td>
                                                <td><a href="customers_details.php?id=<?=$row['id']?>">view</a></td>
                                                <td><a href="guards_posting.php?id=<?=$row['id']?>">assign</a></td>   
                                            </tr>
                                        <?php } ?>
                                        </tbody>
