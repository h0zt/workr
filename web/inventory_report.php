<?php
    ...
    $output = new OutPut();
    $inventories = $output->guardInventoryView();
?>
...
<head>
    ...
    <title>Rock Security Services | Inventory Report</title>
    <!-- Favicon icon -->
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                       <a class="has-arrow" href="inventory_report.php" >
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="dataTables" style="width:100%" class="table table-striped table-bordered zero-configuration display nowrap">
                                        <thead>
                                            <tr>
                                                <th scope="col">Date/ Return Date</th>
                                                <th scope="col">PPE</th>
                                                <th scope="col">QTY/ Return QTY</th>
                                                <th scope="col">No/ Return No</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach($inventories as $inventory){ ?>
                                            <tr>
                                                <td><span><?=$inventory['submited']?></span> <span class="bg-primary text-white"><?=$inventory['returned']?></span></td>
                                                <td><?=$inventory['ppe']?></td>
                                                <td><span><?=$inventory['qty']?></span> <span class="bg-primary text-white"><?=$inventory['qty_return']?></span></td>
                                                <td><span><?=$inventory['no']?></span> <span class="bg-primary text-white"><?=$inventory['no_return']?></span></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
